...
// show the movies in the page (Movies) from api's data 
const options = {
    method: 'GET',
    headers: {
...
// remove the prev list of movies and sort the data from api by the firt letter and show it again in the page (Movies)
...
// remove the prev list of movies and sort the data from api by the evaluation and show it again in the page (Movies)
